...
export const metadata: Metadata = {
  title: APP_CENTRAL_NAME,
  description: "Criminal Intelligence & Surveillance Platform",
};
...
export default function RootLayout({ children }: LayoutProps<"/">) {
  return (
    ...
    >
      <head>
        {/* Material Symbols isn't in next/font/google's catalog; loaded here in the root layout, so it's shared by every route. */}
